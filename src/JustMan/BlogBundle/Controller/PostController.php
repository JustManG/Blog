...
use JustMan\BlogBundle\Entity\Post;
use JustMan\BlogBundle\Form\PostType;
...
class PostController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('JustManBlogBundle:Post')->findAll();
     ...
     * @Route("", name="_create")
     * @Method("POST")
     * @Template("JustManBlogBundle:Post:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('JustManBlogBundle:Post')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("JustManBlogBundle:Post:edit.html.twig")
     */
