...
use Masl\Bundle\MPTBundle\Entity\Tag;
use Masl\Bundle\MPTBundle\Form\TagType;
...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MaslMPTBundle:Tag')->findAll();

        return $this->render('MaslMPTBundle:Tag:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('MaslMPTBundle:Tag:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MaslMPTBundle:Tag')->find($id);
        ...
        return $this->render('MaslMPTBundle:Tag:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('MaslMPTBundle:Tag:edit.html.twig', array(
            'entity'      => $entity,
